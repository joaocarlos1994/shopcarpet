...
package br.com.shopcarpet.authentication.jwt;
...
import br.com.shopcarpet.authentication.PreAuthenticatedAuthentication;
import br.com.shopcarpet.infrastructure.persist.user.UserRepositoryJpa;
...
public class JwtAuthenticationManager implements AuthenticationManager {
    ...
    @Autowired
    public JwtAuthenticationManager(final UserRepositoryJpa repository) {
        super();
    ...
    public Authentication authenticate(final Authentication auth) throws AuthenticationException {
        ...
        return new PreAuthenticatedAuthentication(repository.loadByUsername(username));
    }
