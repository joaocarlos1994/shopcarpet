...
/**
 * A <code>WebConfig</code> é o DispatcherServlet da aplicacao
 * todas requisicoes irao passar por ele. Portanto extendemos
 * a <code>WebMvcConfigurerAdapter</code> para expor o minimo
 * de configuracao possivel
 * */
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {"br.com.shopcarpet.restapi"})
